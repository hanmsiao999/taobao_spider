...
def refund_jiexi(shop_id, content,update_time):
        ...
        if u"持平" in tds[2]:
            ...
            after_sales_speed_nearly_30_compare = -1 if len(after_sales_speed_nearly_30_compare)==0 else after_sales_speed_nearly_30_compare[0]
        ...
        if len(tmp)!=0:
           ...
           full_refund_speed_nearly_30 = -1 if len(full_refund_speed_nearly_30)==0 else full_refund_speed_nearly_30[0]
           #print "full_refund_speed_nearly_30",full_refund_speed_nearly_30
        else:
        ...
        if u"持平" in tds[2]:
            ...
            dispute_rate_nearly_30_compare = -1 if len(dispute_rate_nearly_30_compare)==0 else dispute_rate_nearly_30_compare[0]
        ...
        if u"持平" in tds[2]:
            ...
            after_sale_rate_nearly_30_compare = -1 if len(after_sale_rate_nearly_30_compare)==0 else after_sale_rate_nearly_30_compare[0]
        ...
        aftersale_attitude_score_nearly_180 = -1 if len(aftersale_attitude_score_nearly_180)==0 else aftersale_attitude_score_nearly_180[0]
        ...
        if u"持平" in tds[2]:
            ...
            aftersale_attitude_score_nearly_180_compare = -1 if len(aftersale_attitude_score_nearly_180_compare)==0 else aftersale_attitude_score_nearly_180_compare[0]
        ...
        if u"持平" in tds[2]:
            ...
            after_sale_rate_nearly_180_compare = -1 if len(after_sale_rate_nearly_180_compare)==0 else after_sale_rate_nearly_180_compare[0]
...
f = codecs.open("60551274_refund_jiexi.txt","r+",encoding="utf-8")
html = f.read()
f.close()
refund_jiexi(1000,html,"2017-06-06")
